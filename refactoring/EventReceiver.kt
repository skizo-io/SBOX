...
fun addEventReceiver(type: String, listener: IEventReceiver) =
    addReceiver(type, listener::onEventReceiver)
fun addEventReceiver(type: String, listener: () -> Unit) = addReceiver(type, listener)
fun addEventReceiver(type: String, listener: (ReceiverItem) -> Unit) =
