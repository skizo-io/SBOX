...
fun Context.getLayoutFromResource(@LayoutRes resId: Int): View {
    return LayoutInflater.from(this).inflate(resId, null)
}
fun Context.getLayoutFromResource(@LayoutRes resId: Int, parent: ViewGroup, attachToRoot: Boolean = false): View {
